...
/*
        .footer:after {
            content: "";
            background-image: url(../assets/front/images/up-arrow.png);
            position: absolute;
            bottom: 100%;
            right: 50%;
            margin-right: -9px;
...
*/
    ...
    <div class="totaltableback">
        ...
        <div class="totaltable" style="width: 640px; margin: 0 auto; background: #fff; padding: 30px; box-shadow: 0px 0px 15px #44444414 !important">
            ...
            <div class="table-responsive">
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <tr>
                                <td><p>We have received a request to reset the password on your BenaSmart Account. </p></td>
                            </tr>
                            <tr>
                                <td><p>Here is your OTP: <?php echo $otp; ?>. </p></td>
                            </tr>
                            <tr>
                                <td><p>Enter this OTP to complete the reset. </p></td>
                            </tr>
                            <tr>
                                <td><p>Thanks for helping us keep your account secure .</p></td>
                            </tr>
