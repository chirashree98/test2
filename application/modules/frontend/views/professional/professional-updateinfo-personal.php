                    ...
                    <form action="<?php echo base_url('professional/updateinfo/personal/success'); ?>" method="post" onsubmit="return form_validation1();">
                        ...
                        <div class="form-group col-md-4 form-up-down-details">
                            ...
                            <div class="select-area company-ph-selected-area ">
                                <select class="custom-select form-control" id="std_code" disabled>
                            ...
                            <div class="inputarea company-ph-inputarea">
                                <input type="number" class="form-control" id="bank_mobile_no" placeholder="Mobile number" value="<?php echo $user_detail[0]['mobile_no']; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Your Email</label>
                            <input type="text" class="form-control" placeholder="EmailID" id="email" value="<?php echo $user_detail[0]['email']; ?>" readonly>
                        </div>
