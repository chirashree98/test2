                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        <div class="why-choose-right plm plumber-profile-details">
                            ...
                            <a class="plumber-profile-user-view-btn our-support-btn" href="<?php echo base_url(); ?>hire-professionals/<?php echo $user_encode_id; ?>"> <i class="fa fa-plus" aria-hidden="true"></i> Hire <?php echo $user_detail[0]['name']; ?></a>
                             <?php } else { ?>
                                                <a class="plumber-profile-user-view-btn our-support-btn" data-toggle="tooltip" data-placement="top" title="" data-original-title="Please login as customer to hire"><i class="fa fa-plus" aria-hidden="true"></i> Hire <?php echo $user_detail[0]['name']; ?></a>
        <?php } ?>
                        </div>
                    </div>
                </div>
