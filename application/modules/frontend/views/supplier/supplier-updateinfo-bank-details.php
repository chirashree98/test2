    ...
    <section id="supplier-pagenav">
        <div class="container">
            ...
            <ul>
                ...
                <li class="active"><a href="<?php echo base_url('supplier/updateinfo/bank-details'); ?>">Bank Details</a></li>
            </ul>
            <?php } ?>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="company-details-form">
                    <form action="<?php echo base_url('supplier/updateinfo/bank-details/success'); ?>" method="post" onsubmit="return form_validation1();">
