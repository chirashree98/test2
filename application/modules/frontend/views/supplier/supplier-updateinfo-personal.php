...
<body>
    ...
    <section id="supplier-pagenav">
        <div class="container">
            ...
            <?php }else{ ?>
            <ul>
                <li class="active"><a href="<?php echo base_url('supplier/updateinfo/personal'); ?>">Personal Details</a></li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="company-details-form">
                    <form action="<?php echo base_url('supplier/updateinfo/personal/success'); ?>" method="post" onsubmit="return form_validation1();">
