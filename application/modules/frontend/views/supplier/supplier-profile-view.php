...
<head>
    ...
    <!--   <style>
            ...
            #why-choose .plumber-profile-user-view-btn{float: left; text-align: center;}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        <div class="why-choose-right plm plumber-profile-details">
                            ...
                            <a class="plumber-profile-user-view-btn our-support-btn" href="<?php echo base_url('supplier/updateinfo/personal'); ?>">Update Profile</a>
                        </div>
                    </div>
                </div>
            </div>
