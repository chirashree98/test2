    ...
    <section id="supplier-pagenav">
        <div class="container">
            ...
            <ul>
                ...
                <li class="active"><a href="<?php echo base_url('supplier/updateinfo/about-us'); ?>">About Us</a></li>
    ...
    <section id="company-details">
        <div class="container">
            ...
            <div class="company-details-form company-about-us">
                <form action="<?php echo base_url('supplier/updateinfo/about-us/success'); ?>" method="post" onsubmit="return form_validation1();">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
