                    ...
                    <div class="page-content">
                        ...
                        <div class="card radius-15">
                            <div class="card-body">
                                ...
                                <?php } ?>
                                <hr/>
                                <form action="<?php echo base_url('admin-cms-add-new-category-success1'); ?>" method="post" onsubmit="return form_validation();">
                                    <input type="hidden" name="usertype_id" value="<?php echo $role_list[0]['id']; ?>">
