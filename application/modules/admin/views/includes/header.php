<?php 
$notification_list = get_active_notification();
?>
...
<!--                <li class="nav-item dropdown dropdown-lg">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <div class="header-message-list">
                            <a class="dropdown-item" href="javascript:;">
                                <div class="media align-items-center">
                                    <div class="user-online">
                                        <img src="<?php echo base_url(); ?>assets/admin/images/avatars/avatar-1.png" class="msg-avatar" alt="user avatar">
                                    </div>
                            ...
                            <a class="dropdown-item" href="javascript:;">
                                <div class="media align-items-center">
                                    <div class="user-online">
                                        <img src="<?php echo base_url(); ?>assets/admin/images/avatars/avatar-2.png" class="msg-avatar" alt="user avatar">
                                    </div>
                                    <div class="media-body">
                            ...
                            <a class="dropdown-item" href="javascript:;">
                                <div class="media align-items-center">
                                    <div class="user-online">
                                        <img src="<?php echo base_url(); ?>assets/admin/images/avatars/avatar-3.png" class="msg-avatar" alt="user avatar">
                                    </div>
                                    <div class="media-body">
                            ...
                            <a class="dropdown-item" href="javascript:;">
                                <div class="media align-items-center">
                                    <div class="user-online">
                                        <img src="<?php echo base_url(); ?>assets/admin/images/avatars/avatar-4.png" class="msg-avatar" alt="user avatar">
                                    </div>
                                    <div class="media-body">
                            ...
                            <a class="dropdown-item" href="javascript:;">
                                <div class="media align-items-center">
                                    <div class="user-online">
                                        <img src="<?php echo base_url(); ?>assets/admin/images/avatars/avatar-5.png" class="msg-avatar" alt="user avatar">
                                    </div>
                                    <div class="media-body">
                            ...
                            <a class="dropdown-item" href="javascript:;">
                                <div class="media align-items-center">
                                    <div class="user-online">
                                        <img src="<?php echo base_url(); ?>assets/admin/images/avatars/avatar-6.png" class="msg-avatar" alt="user avatar">
                                    </div>
                                    <div class="media-body">
                            ...
                            <a class="dropdown-item" href="javascript:;">
                                <div class="media align-items-center">
                                    <div class="user-online">
                                        <img src="<?php echo base_url(); ?>assets/admin/images/avatars/avatar-7.png" class="msg-avatar" alt="user avatar">
                                    </div>
                                    <div class="media-body">
                            ...
                            <a class="dropdown-item" href="javascript:;">
                                <div class="media align-items-center">
                                    <div class="user-online">
                                        <img src="<?php echo base_url(); ?>assets/admin/images/avatars/avatar-8.png" class="msg-avatar" alt="user avatar">
                                    </div>
                                    <div class="media-body">
                            ...
                            <a class="dropdown-item" href="javascript:;">
                                <div class="media align-items-center">
                                    <div class="user-online">
                                        <img src="<?php echo base_url(); ?>assets/admin/images/avatars/avatar-9.png" class="msg-avatar" alt="user avatar">
                                    </div>
                                    <div class="media-body">
                            ...
                            <a class="dropdown-item" href="javascript:;">
                                <div class="media align-items-center">
                                    <div class="user-online">
                                        <img src="<?php echo base_url(); ?>assets/admin/images/avatars/avatar-10.png" class="msg-avatar" alt="user avatar">
                                    </div>
                                    <div class="media-body">
                            ...
                            <a class="dropdown-item" href="javascript:;">
                                <div class="media align-items-center">
                                    <div class="user-online">
                                        <img src="<?php echo base_url(); ?>assets/admin/images/avatars/avatar-11.png" class="msg-avatar" alt="user avatar">
                                    </div>
                                    <div class="media-body">
                ...
                <li class="nav-item dropdown dropdown-lg">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="javascript:;" data-toggle="dropdown" onclick="return make_all_notification_old();"><i class="bx bx-bell vertical-align-middle"></i>
                        <span class="msg-count"><?php echo count($notification_list); ?></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right cusdr">
                        <a href="javascript:;">
                            <div class="msg-header">
                                <h6 class="msg-header-title"><?php echo count($notification_list); ?> New</h6>
                                <p class="msg-header-subtitle">Notifications</p>
                            </div>
                        </a>
                        <div class="header-notifications-list">
                            <?php foreach($notification_list as $val){ ?>
                            <ul>
                            <li><a class="dropdown-item customdrop" href="javascript:;">
                                    <div class="media align-items-center">
                                        <div class="notify bg-light-primary text-primary"><i class="bx bx-group"></i>
                                        </div>
                                        <div class="media-body">
                                            <h6 class="msg-name"><?php echo $val['type']; ?></h6>
                                            <p class="msg-info"><?php echo $val['message']; ?></p>
                                        </div>
                                    </div>
                                </a></li>
                            </ul>
                    ...
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;" data-toggle="dropdown">
                        <div class="media user-box align-items-center">
                            <div class="media-body user-info">
                                <p class="user-name mb-0">Admin Admin</p>
                                <p class="designattion mb-0">Available</p>
                            </div>
                            <img src="<?php echo base_url(); ?>assets/admin/images/avatars/avatar-1.png" class="user-img" alt="user avatar">
                        </div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right cusdr">	
<!--                        <a class="dropdown-item" href="javascript:;"><i
                        ...
                        <div class="dropdown-divider mb-0"></div>	<a class="dropdown-item" href="<?php echo base_url('logout'); ?>"><i
...
<script>
    function make_all_notification_old(){
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url('ajax-make-all-notification-old'); ?>',
            data: 'all=' + 1,
