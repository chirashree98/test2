                    ...
                    <div class="page-content">
                        ...
                        <div class="card radius-15">
                            <div class="card-body">
                                ...
                                <hr/>
                                <form action="<?php echo base_url('admin/add-new-logo-succ'); ?>" method="post" onsubmit="return form_validation();" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label>Image:</label>
                                        <img src="<?php echo base_url('assets/front/images/210.120.png'); ?>" style="height:130px;width:230px">
