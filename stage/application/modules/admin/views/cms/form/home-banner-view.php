                    ...
                    <div class="page-content">
                        ...
                        <div class="card radius-15">
                            <div class="card-body">
                                ...
                                <hr/>
                                <form action="<?php echo base_url('admin/cms/update-home-banner'); ?>" method="post" onsubmit="return form_validation();" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label>Title:</label>
                                        <input type="text" class="form-control" id="title" name="title" value="<?php echo $data_list[0]['title']; ?>" placeholder="Title">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="<?php echo base_url($data_list[0]['pic_location']); ?>" style="height:500px;width:800px">
                                    </div>
                                    <div class="form-group">
                                        
                                        <label>Banner Image:</label>
                                        <img src="<?php echo base_url('assets/front/images/1600.550.png'); ?>" style="height:150px;width:250px">
