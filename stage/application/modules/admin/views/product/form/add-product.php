...
<!--
                                        <div class="col-sm-8 form-group">
                                            <label> Select Attribute(s):</label><br>
                                            <?php 
                                            $i = 1;
                                            foreach($attribute_list as $val){ 
                                                echo $val['name'];
                                            ?>
                                            <input type="checkbox" id="attribute_id_<?php echo $i; ?>" name="attribute_id" value="<?php echo $val['id']; ?>">
                                            <?php 
                                            $i++;
                                            } ?>
                                        </div>
                                        <div class="col-sm-4 form-group">
                                            <a class="btn btn-success" style="float: right;padding: 10px 18px;margin-right: 100px;" onclick="return get_child_attribute();">Create Variations</a>
                                        </div>
-->
