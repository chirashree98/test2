<!--<style>
    ...
    .loginwithsupp-pro h6 {
        font-size: 14px;
        color: #19222e;
        font-weight: 600;
    }

    .loginwithsupp-pro h6 a {
        color: #3a77ff;
    }
                ...
                <section id="login">
                    ...
                    <div class="login-inner-sub popupnew">
                        ...
                        <div class="loginwithsupp-pro">
                            <h6>Login as &nbsp;<a href="#" onclick="return open_professional_login();">Professional</a> &nbsp;|&nbsp;
                                <a href="#" onclick="return open_supplier_login();">Supplier</a> </h6>
                        </div>
                    </div>
                </section>
            </div>
                                    ...
                                    <div class="col-sm-5">
                                        <div class="log">
                                            ...
                                            <div class="res">
                                                ...
                                                <div class="loginwithsupp-pro">
                                                    <h6>Login as &nbsp;<a href="#" onclick="return open_customer_login();">Customer</a> &nbsp;|&nbsp;
                                                        <a href="#" onclick="return open_supplier_login();">Supplier</a> </h6>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-5">
                                        <div class="log">
                                            ...
                                            <div class="res">
                                                ...
                                                <div class="loginwithsupp-pro">
                                                    <h6>Login as &nbsp;<a href="#" onclick="return open_customer_login();">Customer</a> &nbsp;|&nbsp;
                                                        <a href="#" onclick="return open_professional_login();">Professional</a> </h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
