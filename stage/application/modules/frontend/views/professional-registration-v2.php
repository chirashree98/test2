    ...
    <body>
        <style>
            ...
            */
            ...
            .register-professional-main-inner {
                max-width: 100%;
                width: 100%;
                float: left;
                margin: 0 auto;
            ...
            .infoarea li:before {
                border-bottom: 2px solid #a9a9aa8c;
            }
            .custompadding form {
                padding: 29px 32px;
                padding-right: 0;
            ...
            @font-face {
                font-family: 'icomoon';
                src: url('<?php echo base_url(); ?>assets/front/fonts/icomoon.eot?y4zhs8');
                src: url('<?php echo base_url(); ?>assets/front/fonts/icomoon.eot?y4zhs8#iefix') format('embedded-opentype'),
                    url('<?php echo base_url(); ?>assets/front/fonts/icomoon.ttf?y4zhs8') format('truetype'),
                    url('<?php echo base_url(); ?>assets/front/fonts/icomoon.woff?y4zhs8') format('woff'),
                    url('<?php echo base_url(); ?>assets/front/fonts/icomoon.svg?y4zhs8#icomoon') format('svg');
                font-weight: normal;
                font-style: normal;
                font-display: block;
            }
            ...
            .register-professional-inner .nav-item a span {
                font-size: 31px;
                color: #a6a6a7;
            ...
            .register-professional-inner .active a span {
                color: #1df2b5;
                border-color: #1df2b5;
            }
            .cstab2 .pcolor {}
            @media(max-width:767px) {
                ...
                .register-professional-main-inner2 form .row {
                                ...
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="register-professional-main-inner">
                                        <div class="row col-sm-12">
                                            <div class="register-professional-main-inner2 custompadding">
...
<!--                                                        <a href="#" class="btn" name="pro_reg_contact" id="pro_reg_contact"></a>-->
    ...
    <script>
        ...
        $(document).on('click', '#ajax_skill_view .menu.transition.visible .item,#ajax_skill_view a.ui.label.transition.visible .label', function () {
