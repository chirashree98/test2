    ...
    <section id="supplier-pagenav">
        <div class="container">
            ...
            <ul>
                ...
                <li class="active"><a href="<?php echo base_url('professional/updateinfo/company-details'); ?>">Company Details</a></li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="company-details-form">
                    <form action="<?php echo base_url('professional/updateinfo/company-details/success'); ?>" method="post" onsubmit="return form_validation1();">
