...
<body>
    ...
    <section id="supplier-pagenav">
        <div class="container">
            ...
            <?php }else{ ?>
            <ul>
                <li class="active"><a href="<?php echo base_url('professional/updateinfo/personal'); ?>">Personal Details</a></li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="company-details-form">
                    <form action="<?php echo base_url('professional/updateinfo/personal/success'); ?>" method="post" onsubmit="return form_validation1();">
                        <div class="form-group col-md-4">
                            <label>Your Name</label>
                            <input type="text" class="form-control" name="name" id="name" placeholder="Enter Name" value="<?php echo $user_detail[0]['name']; ?>">
                        </div>
                        <div class="form-group col-md-4 form-up-down-details">
                            ...
                            <div class="select-area company-ph-selected-area ">
                                <select class="custom-select form-control" id="std_code" name="std_code">
                                    ...
                                    <option value="<?php echo $val['id']; ?>" <?php if( $user_detail[0]['std_code'] == $val['id']){ echo'selected'; } ?>><?php echo $val['isd_code']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="inputarea company-ph-inputarea">
                                <input type="number" class="form-control" id="bank_mobile_no" name="bank_mobile_no" placeholder="Mobile number" value="<?php echo $user_detail[0]['mobile_no']; ?>">
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Your Email</label>
                            <input type="text" class="form-control" placeholder="EmailID" name="email" id="email" value="<?php echo $user_detail[0]['email']; ?>">
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group col-md-6">
                                        <label>Address</label>
                                        <input type="text" class="form-control" name="address1" id="address1" placeholder="Enter Address" value="<?php echo $personal_detail[0]['address1']; ?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Address Line 2</label>
                                        <input type="text" class="form-control" name="address2" id="address2" placeholder="Enter Address Line 2" value="<?php echo $personal_detail[0]['address2']; ?>">
                                    </div>
                                    <div class="form-group col-md-3 form-location-details">
                                        <label>Country</label>
                                        <select class="custom-select form-control" name="country_id" id="country_id" onchange="return get_state_using_country(this);">
                                            <option value="">Select Country</option>
                                            <?php foreach($std_list as $val){ ?>
                                            <option value="<?php echo $val['id']; ?>" <?php if($personal_detail[0]['country_id'] == $val['id']){ echo'selected'; } ?>><?php echo $val['name']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-3 form-location-details">
                                        ...
                                        <div id="state_view">
                                            <select class="form-control" name="state_id" id="state_id">
                                                ...
                                                <option value="<?php echo $val['id']; ?>" <?php if($personal_detail[0]['state_id'] == $val['id']){ echo'selected'; } ?>><?php echo $val['name']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-3 form-location-details">
                                        ...
                                        <div id="city_view">
                                            <select class="form-control" name="city_id" id="city_id">
                                                ...
                                                <option value="<?php echo $val['id']; ?>" <?php if($personal_detail[0]['city_id'] == $val['id']){ echo'selected'; } ?>><?php echo $val['name']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label>Zip</label>
                                        <input type="text" class="form-control" name="zipcode" id="zipcode" value="<?php echo $personal_detail[0]['zipcode']; ?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-md-12 pb-0 mb-0">
                            <input type="submit" class="login-btn btn" name="pro_btn_sub" value="Update Now!">
                        </div>
                    </form>
                </div>
            </div>
