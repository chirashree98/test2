...
*/
        ...
        @font-face {
            font-family: 'icomoon';
            src: url('https://workb4live.com/benasmart/assets/front/fonts/icomoon.eot?y4zhs8');
            src: url('https://workb4live.com/benasmart/assets/front/fonts/icomoon.eot?y4zhs8#iefix') format('embedded-opentype'),
                url('https://workb4live.com/benasmart/assets/front/fonts/icomoon.ttf?y4zhs8') format('truetype'),
                url('https://workb4live.com/benasmart/assets/front/fonts/icomoon.woff?y4zhs8') format('woff'),
                url('https://workb4live.com/benasmart/assets/front/fonts/icomoon.svg?y4zhs8#icomoon') format('svg');
            font-weight: normal;
            font-style: normal;
            font-display: block;
        }
