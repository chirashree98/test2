        ...
        <section id="register-professional">
            <div class="container">
                ...
                <div class="register-professional-inner">
                    <p>Set up your BenaSmart Professional/Supplier Account</p>
                    ...
                    <ul class="infoarea">
                        ...
                        <li><a><img src="<?php echo base_url('assets/front/'); ?>images/contact-info.png" /></a> <span>Contact Info</span></li>
                    ...
                    <div class="register-professional-main-inner">
                        <div class="register-professional-main-inner2 1stpge">
                            <form action="<?php echo base_url('professional-registration-succ'); ?>" method="post" enctype="multipart/form-data" onsubmit="return form_validation1();">
                                ...
                                <div class="form-group" id="add_skill_view">
                                    <div class="">
                                        ...
                                        <div class="col-sm-6 pl-0 add-skill-text">
